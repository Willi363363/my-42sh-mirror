...
static int handle_repeat(char *command, shell_parameters_t *shell)
{
...
static int handle_misc_lookup(shell_parameters_t *shell)
{
    ...
    return handle_repeat(shell->command[0], shell);
}
